...
VIP_USERS = [7899672241] # আপনার আইডি
...
# --- BUTTON HANDLER (Fixes the "Click but no response" issue) ---
...
def main():
    # drop_pending_updates=True দিলে পুরনো জমে থাকা ক্লিকগুলো ক্লিয়ার হয়ে যাবে
    application = Application.builder().token(TOKEN).build()
    
    application.add_handler(CommandHandler("start", start))
    application.add_handler(CallbackQueryHandler(handle_buttons)) # বাটন কানেক্ট করা হয়েছে
    
    print("Bot is Live and Buttons are Ready!")
