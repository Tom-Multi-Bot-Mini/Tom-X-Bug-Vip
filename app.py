...
# [CRITICAL] আপনার চ্যানেলের ইউজারনেম এখানে দিন (@ সহ), বটকে এই চ্যানেলে Admin হতে হবে
CHANNEL_ID = "@tomxbugvip" 
...
async def is_subscribed(context, user_id):
    try:
        ...
        logging.error(f"Sub check failed: {e}")
        return False
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # মেম্বারশিপ চেক - জয়েন না করলে শুধু সাবস্ক্রিপশন বাটন দেখাবে
    if not await is_subscribed(context, user_id):
        sub_text = (
            "❌ **You must subscribe my telegram channel to use this bot.**\n"
            "After doing so, click \"Check Membership\"."
        )
