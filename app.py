...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Force Subscribe Logic from your screenshot
    if not await is_subscribed(context, user_id):
        ...
        sub_kb = InlineKeyboardMarkup([
            [InlineKeyboardButton("📢 Join Channel", url=f"https://t.me/tomxbugvip")],
            [InlineKeyboardButton("👥 Join Group",https://t.me/tomxbugvip)],
            [InlineKeyboardButton("🎥 Subscribe YouTube",https://youtube.com/@saycotom?si=nlptFT57FmTMfDrY)],
